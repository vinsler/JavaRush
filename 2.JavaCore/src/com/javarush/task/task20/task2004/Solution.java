...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (classWithStatic.equals(loadedObject)) {
                System.out.println("Object has DUCE, good job!");
            } else {
                System.out.println("Object dosn.t DUCE!!! Trouble shoot.");
            }
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            printWriter.println(getStaticString());
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            while (bufferedReader.ready()) {
                setStaticString(bufferedReader.readLine());
