...
public class Solution {
    ...
    public static class Rectangle{
        ...
        public HasHeight castToHasHeight() { // Меняем название
            class InnerHasHeight implements HasHeight { // создаем внутренний локальный класс реализуем от HasHeight
                @Override // переопределяем
                public double getHeight() {
                    return Math.abs(point1.getY() - point2.getY()); // возвращаем разницу координат
                }
            }
            return new InnerHasHeight(); // возвращаем обьект класса HasHeight
        }
